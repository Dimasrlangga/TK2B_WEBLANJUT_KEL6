  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="index.php?p=user" class="nav-link">User</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="naruto.jpg" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
        ...
        <nav class="mt-2 mb-3">
          <ul class="nav nav-pills nav-sidebar flex-column mb-3" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="index.php?" class="nav-link <?= (!isset($_GET['p'])) ? 'active' : '' ?>">
            ...
            <li class="nav-item">
            <a href="?p=mhs" class="nav-link <?= (isset($_GET['p']) && $_GET['p']=='mhs') ? 'active' : '' ?>">
            ...
            <li class="nav-item">
            <a href="?p=prodi" class="nav-link <?= (isset($_GET['p']) && $_GET['p']=='prodi') ? 'active' : '' ?>">
            ...
            <li class="nav-item">
            <a href="?p=dosen" class="nav-link <?= (isset($_GET['p']) && $_GET['p']=='dosen') ? 'active' : '' ?>">
            ...
            <li class="nav-item">
            <a href="?p=kategori" class="nav-link <?= (isset($_GET['p']) && $_GET['p']=='kategori') ? 'active' : '' ?>">
            ...
            <li class="nav-item">
              <a href="?p=berita" class="nav-link <?= (isset($_GET['p']) && $_GET['p']=='berita') ? 'active' : '' ?>">
                <i class="fas fa-tv"></i>
                <p>
                  Berita
                </p>
            ...
            <li class="nav-item">
            <a href="?p=ruangan" class="nav-link <?= (isset($_GET['p']) && $_GET['p']=='ruangan') ? 'active' : '' ?>">
